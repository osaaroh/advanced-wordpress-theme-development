...
function aquila_posted_on() {
    ...
    //get_the_time - gets the time current post was written
    //get_the_modified_time - gets the time current post was modified
...
function aquila_the_excerpt($trim_character_count = 0){
    ...
    //Code below will only work if there is excerpt  on the post and there is character count
