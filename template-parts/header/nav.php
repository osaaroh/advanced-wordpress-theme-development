    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        foreach ($header_menus as $menu_item){
          //If the value of menu_item_parent is 0 or falsy it means its a parent as non parent Menus will have a value here.
          if (!$menu_item->menu_item_parent){
            ...
            ?>
              <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle" href="<?php echo esc_url($menu_item->url)?>" role="button" data-bs-toggle="dropdown" aria-expanded="false"><?php echo esc_html($menu_item->title)?></a>
...
<?php
    // wp_nav_menu( 
    //   array( 'theme_location' => 'aquila-header-menu', 
